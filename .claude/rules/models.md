...
- Photo search: Postgres FTS on `photos.tsv` (title, description, album titles, tags), maintained by the trigger in `db/migrate/20231107090606_create_trigger_tsvupdate_v5.rb`.
